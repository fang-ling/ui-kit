...
enum UIJavaScriptBridge { }

extension UIJavaScriptBridge {
  enum HTMLElement { }
}

extension UIJavaScriptBridge.HTMLElement {
  enum `Type`: UnsignedInteger32 {
    case division = 1
    case span = 2
    case button = 3
  }
  ...
  @_extern(
    wasm,
    module: "env",
    name: "UIJavaScriptBridge_HTMLElement_Initialize"
  )
  static func initialize(
    _ htmlElementType: UnsignedInteger32,
    _ id: UnsignedInteger32,
    _ parentID: UnsignedInteger32
  )

  @_extern(
    wasm,
    module: "env",
    name: "UIJavaScriptBridge_HTMLElement_SetStyleProperty"
  )
  static func setStyleProperty(
    _ id: UnsignedInteger32,
